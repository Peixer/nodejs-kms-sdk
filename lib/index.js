...
class KmsClient {
  ...
  /**
   * @description asymmetric sign message
   * @see https://help.aliyun.com/document_detail/148132.html
   * @param keyId {string} required: global unique identifier
   * @param digest {string} required: original message
   * @param keyVersionId {string} required: version ID of key
   * @param runtimeOption {object} optional: set timeout, default is 10s
   */
  async asymmetricSign(keyId, digest, keyVersionId, runtimeOption = {}) {
    if (!keyId ) {
      throw new Error('keyId & plaintext must be passed in, please see https://help.aliyun.com/document_detail/28949.html');
    }
    return this.client.AsymmetricSign({
   ...
   * @see https://help.aliyun.com/document_detail/148134.html
   * @param keyId {string} required: global unique identifier
   * @param keyVersionId {string} required: version ID of key
   * @param runtimeOption {object} optional: set timeout, default is 10s
   */
  async getPublicKey(keyId, keyVersionId, runtimeOption = {}) {
    if (!keyId ) {
      throw new Error('keyId & plaintext must be passed in, please see https://help.aliyun.com/document_detail/28949.html');
    }
